...
export NOTIFICATION_GITHUB_REPO_URL="https://github.com/MPCS51205-TMACs/notification-service.git"
export NOTIFICATION_DIR_NAME="notification-service"
export NOTIFICATION_IMG_NAME="maven/builder:notification-service"
export NOTIFICATION_IMG_DOCKERFILE="$PROJECT_DIR_PATH/notification-service/"
echo notification
echo 
echo NOTIFICATION_GITHUB_REPO_URL=$NOTIFICATION_GITHUB_REPO_URL
echo NOTIFICATION_DIR_NAME=$NOTIFICATION_DIR_NAME
echo NOTIFICATION_IMG_NAME=$NOTIFICATION_IMG_NAME
echo NOTIFICATION_IMG_DOCKERFILE=$NOTIFICATION_IMG_DOCKERFILE
echo
...
echo SHOPPING_CART_DIR_NAME=$SHOPPING_CART_DIR_NAME
echo SHOPPING_CART_IMG_NAME=$SHOPPING_CART_IMG_NAME
echo SHOPPING_CART_IMG_DOCKERFILE=$SHOPPING_CART_IMG_DOCKERFILE
echo
...
# echo GATEWAY_GITHUB_REPO_URL=$GATEWAY_GITHUB_REPO_URL
echo GATEWAY_PY_DIR_NAME=$GATEWAY_PY_DIR_NAME
echo GATEWAY_PY_IMG_NAME=$GATEWAY_PY_IMG_NAME
echo GATEWAY_PY_IMG_DOCKERFILE=$GATEWAY_PY_IMG_DOCKERFILE
echo
